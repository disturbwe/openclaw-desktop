...
// ============================================================================
// Embedded Gateway Log Subscription Support
// ============================================================================
...
/**
 * Subscribe to all log entries from the gateway.
 ...
 * Called internally by createSubsystemLogger.
 */
...
export function createSubsystemLogger(subsystem: string): SubsystemLogger {
  ...
  const emit = (level: LogLevel, message: string, meta?: Record<string, unknown>) => {
    // Emit to embedded gateway subscribers first
    emitToSubscribers(level, subsystem, message, meta);
